...
pushing a vertical-slice setup with a witch-of-Agnesi hill through the
full-tensor 3D elliptic path (``lap3D``) that the terrain metric terms
attach to. No golden master: the Agnesi regression case is separate.
"""
