...
from vis import utils, plotting_tools as pt
...
class compare_sol(object):
    ...
    def __get_ens(tc, params, attribute, summed=False):
        ...
        ens = tc.get_ensemble(times, 1, attribute, '', label_type=l_typ, tag=tag, inner=False, get_fn=False, fn=params.fn + '.h5', load_ic=False, avg=True)[0]
