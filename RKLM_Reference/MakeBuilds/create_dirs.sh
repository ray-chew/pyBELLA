...
for TEST_C in 'AcousticWave_high' 'InternalWave_Baldauf' 'InternalWave_NH' 'Straka_3D' 'Straka_3D_400m' 'Straka_3D_200m' 'Straka_3D_100m' 'Straka_3D_50m' 'AcousticWave_low' 'InternalWave_H' 'InternalWave_P' 'Travelling-Vortex'
do
