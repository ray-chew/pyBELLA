...
# SK94
#for TESTCASE in 'InternalWave_P_psinc' 'InternalWave_P_hyd' 'InternalWave_P' 'InternalWave_H_psinc' 'InternalWave_H_hyd' 'InternalWave_H' 'InternalWave_NH' 
# Tests in paper
for TESTCASE in 'InternalWave_NH' 'InternalWave_NH_psinc' 'InternalWave_NH_hyd' 'InternalWave_H' 'InternalWave_H_psinc' 'InternalWave_H_hyd' 'InternalWave_P' 'InternalWave_P_psinc' 'InternalWave_P_hyd' 'Straka_3D_400m' 'Straka_3D_200m' 'Straka_3D_100m' 'Straka_3D_50m' 'Straka_3D_25m' #'InternalWave_Baldauf_1200'
#for TESTCASE in 'Straka_3D_400m' 'Straka_3D_200m' 'Straka_3D_100m' 'Straka_3D_50m' 'Straka_3D_25m'
