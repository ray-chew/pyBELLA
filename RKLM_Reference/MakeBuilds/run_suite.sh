...
for TESTCASE in 'InternalWave_P' 'InternalWave_P_psinc' 'InternalWave_P_hyd' 'InternalWave_H' 'InternalWave_H_psinc' 'InternalWave_H_hyd' 'InternalWave_NH' 'Straka_3D_50m' 'TravellingVortex_3D_192' 'InternalWave_Baldauf'
# Tests in paper
