...
Atmospheric dynamics features a variety of scale-dependent motions which have been analytically described by scale analysis and asymptotics \cite{Klein2010,Pedlosky1992}. Reduced dynamical models emerging from the full compressible flow equations through generally singular asymptotic limits capture the essence of the phenomena of interest and reveal which effects are important -- and which ones less so -- for their description. Relevant examples include the anelastic and pseudo-incompressible models, the quasi-geostrophic and semi-geostrophic models, and the hydrostatic primitive model equations \cite{Bannon1996,CullenMaroofi2003,Durran1989,HoskinsBretherton1972,Klein2010,LippsHemler1982,Pedlosky1992}. 
...
\begin{figure}
\centering
 \includegraphics[width=.75\columnwidth]{Grid.pdf}
...
section~\ref{sssec:DivControlledAdvectiveFluxes} 
...
& \ahydro\, W^{n+1}
   =
      \ahydro\, W^n - \dt 
       ...
       \right)
      \\
& \hspace{-3cm} {\Thetatilde}^{n+1}
   =
     {\Thetatilde}^{n} - \dt\frac{d\Thetabar}{dz}\, W^{n+1}
     & \\
& \hspace{-3cm}\apsinc \left(\frac{\partial P}{\partial \pi}\right)^{\circ} {\pi'}^{n+1}
   =
     \apsinc \left(\frac{\partial P}{\partial \pi}\right)^{\circ} {\pi'}^{n}\label{eq:LinearizedNonAdvectiveImplicitEulerPi}\\ 
   &\qquad\qquad\qquad- \dt \left( U^{n+1}_x + V^{n+1}_y + W^{n+1}_z \right)\,.\nonumber
    \end{IEEEeqnarray}
%
  ...
  & =
    &  \frac{1}{1+(\dt f)^2}
      ...
      \left(
        ...
        \end{array}
      \right)^n
\right.      \IEEEyesnumber\IEEEyessubnumber*\\
  & & \left.  - \dt \, c_p (P\Theta)^{\circ} 
      \left(
        \begin{array}{c}
        \pi'_x + \dt\, f\, \pi'_y \\ 
        \pi'_y - \dt\, f\, \pi'_x
      ...
      \right)^{n+1}
      \right] \quad
      \IEEEnonumber\IEEEnosubnumber*\\
W^{n+1} 
  & =
    & \left(\frac{\ahydro W + \dt\, g {\Thetatilde}/\Thetabar}{\ahydro + (\dt\, N)^2}\right)^n \\
  & &     - \dt \, \frac{c_p (P\Theta)^{\circ}}{\ahydro + (\dt\, N)^2} \ {\pi'}^{n+1}_z \,,\IEEEnonumber\IEEEnosubnumber* 
\end{IEEEeqnarray}
%
...
\begin{figure}
\centering
 \includegraphics[width=.75\columnwidth]{Interpolations.pdf}
...
\begin{figure}
\centering
 \includegraphics[width=.75\columnwidth]{straka_dY_snapshot0.pdf}
 \includegraphics[width=.75\columnwidth]{straka_dY_snapshot1.pdf}
 \includegraphics[width=.75\columnwidth]{straka_dY_snapshot2.pdf}
 \includegraphics[width=.75\columnwidth]{straka_dY_snapshot3.pdf}
...
\begin{figure}
\centering
  \includegraphics[width=.75\columnwidth]{straka_dY_snapshot1dcut.pdf}
...
\begin{figure}
\centering
 \includegraphics[width=.75\columnwidth]{IWNH_dY_snapshot0.pdf}
 \includegraphics[width=.75\columnwidth]{IWNH_dY_snapshot1.pdf}
...
\begin{figure}
\centering
 \includegraphics[width=.49\columnwidth]{IWH_dY_snapshot0.pdf}
 \includegraphics[width=.49\columnwidth]{IWHC_dY_snapshot1.pdf}\\
 \includegraphics[width=.49\columnwidth]{IWHP_dY_snapshot1.pdf}
 \includegraphics[width=.49\columnwidth]{IWHH_dY_snapshot1.pdf}\\
  \includegraphics[width=.49\columnwidth]{H_CMP_vs_PS.pdf}
 \includegraphics[width=.49\columnwidth]{H_CMP_vs_HY.pdf}
 ...
 \begin{figure}
\centering
 \includegraphics[width=.49\columnwidth]{IWP_dY_snapshot0.pdf}
 \includegraphics[width=.49\columnwidth]{IWPC_dY_snapshot1.pdf}\\
 \includegraphics[width=.49\columnwidth]{IWPP_dY_snapshot1.pdf}
 \includegraphics[width=.49\columnwidth]{IWPH_dY_snapshot1.pdf}\\
  \includegraphics[width=.49\columnwidth]{P_CMP_vs_PS.pdf}
 \includegraphics[width=.49\columnwidth]{P_CMP_vs_HY.pdf}
...
\begin{figure}
\centering
 \includegraphics[width=.75\columnwidth]{dT_snapshot9_IWB.pdf}
 \includegraphics[width=.75\columnwidth]{v_snapshot9_IWB.pdf}
 \includegraphics[width=.75\columnwidth]{u_snapshot9_IWB.pdf}
