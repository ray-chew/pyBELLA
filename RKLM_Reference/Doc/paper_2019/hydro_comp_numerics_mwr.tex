...
%
\begin{equation}
CFL_{adv} = \max\limits_{i \in \{1,2,3\}}\left(\frac{\dt u_i}{\dx_i}\right)
\end{equation}
%
where $u_i$ are the components of the velocity, $\dx_i$ the grid spacing in the $i$ direction, and the acoustic Courant number as:
%
\begin{equation}
CFL_{ac} = \max\limits_{i \in \{1,2,3\}}\left(\frac{\dt c}{\dx_i}\right)
\end{equation}
%
where $c=\max{\left(\gamma RT\right)}$ denotes the speed of sound.
...
\subsection{Superposition of acoustic-gravity and inertia-gravity waves}
