...
\centering
 ...
 \caption{Travelling vortex on a doubly periodic unit square domain, $192x192$ cells, advective CFL 0.45. Initial data (top) and values after $1\,\textrm{s}$ (bottom), for the density (left) and nodal pressure (right).  Contours every $0.025\,\textrm{kg\,m$^{-3}$}$
...
\begin{figure}
\centering
 \includegraphics[width=.48\columnwidth]{./InternalWave_H/dY/dY_snapshot0.eps}
 \includegraphics[width=.48\columnwidth]{./InternalWave_H/dY/dY_snapshot1.eps}\\
 \includegraphics[width=.48\columnwidth]{./InternalWave_H_psinc/dY/dY_snapshot1.eps}
 \includegraphics[width=.48\columnwidth]{./InternalWave_H_hyd/dY/dY_snapshot1.eps}\\
  \includegraphics[width=.48\columnwidth]{./InternalWave_H/dY/CMP_vs_PS.eps}
 \includegraphics[width=.48\columnwidth]{./InternalWave_H/dY/CMP_vs_HY.eps}\\
 ...
 \begin{figure}
\centering
 \includegraphics[width=.48\columnwidth]{./InternalWave_P/dY/dY_snapshot0.eps}
 \includegraphics[width=.48\columnwidth]{./InternalWave_P/dY/dY_snapshot1.eps}\\
 \includegraphics[width=.48\columnwidth]{./InternalWave_P_psinc/dY/dY_snapshot1.eps}
 \includegraphics[width=.48\columnwidth]{./InternalWave_P_hyd/dY/dY_snapshot1.eps}\\
  \includegraphics[width=.48\columnwidth]{./InternalWave_P/dY/CMP_vs_PS.eps}
 \includegraphics[width=.48\columnwidth]{./InternalWave_P/dY/CMP_vs_HY.eps}\\
