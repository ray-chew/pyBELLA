...
200 &  $-8.8659$ & $0.2148$ & 14855\tabularnewline
100 &  $-9.1831$ & $0.2173$ & 15180\tabularnewline
...
\centering
 ...
 \caption{Potential temperature perturbation for the hydrostatic inertia-gravity wave test from \cite{SkamarockKlemp1994},  $\Delta x=20\,\textrm{km},\,\Delta z=1\,\textrm{km}$, CFL$=0.9$. Initial data (top) and computed value at final time $T=60000\,\textrm{s}$ in compressible mode (middle) and pseudo-incompressible mode (bottom). Contours as in Figure \ref{fig:SK94_NH}.}
 \label{fig:SK94_H}
 \end{figure}
