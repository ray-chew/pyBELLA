...
\begin{figure}
 \includegraphics[width=.45\columnwidth]{./AcousticWave_low/rho/rho_snapshot0.eps}
 \includegraphics[width=.45\columnwidth]{./AcousticWave_low/rho/rho_snapshot1.eps}\\
\includegraphics[width=.45\columnwidth]{./AcousticWave_high/rho/rho_snapshot0.eps}
 \includegraphics[width=.45\columnwidth]{./AcousticWave_high/rho/rho_snapshot1.eps}
...
\begin{figure}
 \includegraphics[width=.45\columnwidth]{./AcousticWave_low/u/u_snapshot0.eps}
 \includegraphics[width=.45\columnwidth]{./AcousticWave_low/u/u_snapshot1.eps}\\
 \includegraphics[width=.45\columnwidth]{./AcousticWave_high/u/u_snapshot0.eps}
 \includegraphics[width=.45\columnwidth]{./AcousticWave_high/u/u_snapshot1.eps}
...
\begin{figure}
 ...
 \caption{Initial (above) and final (below) potential temperature perturbation for the nonhydrostatic inertia-gravity wave test form \cite{SkamarockKlemp1994}.}
\end{figure}
...
\begin{figure}
 ...
 \caption{Initial (above) and final (below) potential temperature perturbation for the hydrostatic inertia-gravity wave test form \cite{SkamarockKlemp1994}.}
\end{figure}
...
\begin{figure}
 ...
 \caption{Initial (above) and final (below) potential temperature perturbation for the new planetary-scale inertia-gravity wave test form \cite{SkamarockKlemp1994}.}
\end{figure}
