...
\begin{figure}
 \includegraphics[width=\columnwidth]{./Acoustic-Wave/rho/rho_snapshot1.eps}
 \caption{Density at initial time (blue) and final time (red) for the acoustic wave test with $\tilde{c}=0.01c_{ref}$.}
\end{figure}
...
\begin{figure}
 \includegraphics[width=\columnwidth]{./SK94_NH/dY/dY_snapshot0.eps}
 \includegraphics[width=\columnwidth]{./SK94_NH/dY/dY_snapshot1.eps}
...
\begin{figure}
 \includegraphics[width=\columnwidth]{./SK94_H/dY/dY_snapshot0.eps}
 \includegraphics[width=\columnwidth]{./SK94_H/dY/dY_snapshot1.eps}
...
\begin{figure}
 \includegraphics[width=\columnwidth]{./figures/SK94_P/dY/dY_snapshot0.eps}
 \includegraphics[width=\columnwidth]{./figures/SK94_P/dY/dY_snapshot1.eps}
