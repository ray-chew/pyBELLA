...
The Appendix contains a detailed description of the scheme, as well as a tabular summary for convenience.
...
In the following, we describe the main features of the discretization, that evolves and joins aspects of the models in \cite{Klein2009}
