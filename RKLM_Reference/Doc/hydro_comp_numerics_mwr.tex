...
%
\begin{itemize}
 \item Evolves the full compressible equations with rotation in terms of full variables rather than perturbations around an externally prescribed or evolving background state -- perurbations for the inverse potential temperature are only used to build the gravity-implicit elliptic problem;
