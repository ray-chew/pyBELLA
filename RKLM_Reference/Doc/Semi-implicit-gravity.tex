...
%
\begin{IEEEeqnarray}{rCl}\label{eq:EULAGHalfTimePredictorFluxCorrection}
\dss (P\Psi)^{n+\half} 
  & = 
...
i.e., yet I have my doubts regarding the treatment of the Exner pressure in the
momentum equations. I am not sure the $P$-$\pi$ coupling through the equations
of state is correctly captured in \eq{eq:ImplicitEulerStep}.
%
