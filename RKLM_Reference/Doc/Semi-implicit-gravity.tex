...
step. Since both $\rho$ and $P$ are frozen in this split step, the relevant 
...
\end{equation}
%
and where the coefficient $(P\Theta)^*$ is time independent and prescribed.  
...
{\Thetatilde}^{n+1}
  & =
    & {\Thetatilde}^{n} - \Delta t\, W^{n+1}\frac{d\Thetabar}{dz}
      \\
...
W^{n+1} 
  & =
    & \frac{W^n + \Delta t\, g {\Thetatilde}^{n}/\Thetabar}{1 + (N\Delta t)^2}
      - \Delta t \, \frac{c_p (P\Theta)^*}{1 + (N\Delta t)^2} \ {\pi'}^{n+1}_z
\end{IEEEeqnarray}
%
