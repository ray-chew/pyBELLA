...
the EULAG model \citep{EULAG-Numerics-Reference}. The governing equations for 
...
\end{subequations}
%
Here ... is ..., ... is ..., $\pi$ is the Exner pressure, and 
$P = \pi^{\frac{1}{\gamma-1}}$ \klein{(definitions to be filled in)}.
...
\end{equation}
%
The mass transport equation can be cast in the form of a transport 
equation for $\chi = 1/\Theta$, 
%
...
\end{equation}
%
or equivalently, for differentiable solutions, as an advection equation
%
...
and the right hand side column presents the forces acting to change the 
momentum field. These equations are written in compact form as
%
\begin{equation}
