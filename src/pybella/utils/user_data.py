...
class UserDataInit:
    ...
    def _initialise_computed_attributes(self):
        ...
        for computation in computed_attrs:
            ...
            if not hasattr(self, computation) and self._dep_manager.can_compute(self, computation):
    ...
    def _update_dependencies(self, changed_attr):
        ...
        self._updating = True
        try:
            computations_to_update = self._dep_manager.get_computations_to_update(changed_attr)
